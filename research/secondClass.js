...
class Person {
    ...
    // j'utilise un nouveau mot clef set qui indique au JS que cette fonctionne la 
    // doit être executé QUAND j'essaye d'écrire dans la variable Person.firstname
    set firstname(value) {
    ...
    // get -> mot clef speciale pour transforer la fonction en fonction speciale de lecture 
    // de la variable
    get firstname() {
